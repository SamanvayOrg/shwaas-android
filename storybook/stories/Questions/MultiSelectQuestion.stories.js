...
storiesOf('MultiSelectQuestion', module)
    .add('basic view', () => (
        <SelectQuestion
            number={2}
            question={{key: 'comorbidities', helpText: 'directlyObserve', options: ['diabetes', 'hypertension', 'heartDisease', 'asthma', 'lungDisease', 'sickleCellDisease', 'liverDisease','kidneyDisease','pregnancy','obesity','anemia','hiv','cancer','none']}}
