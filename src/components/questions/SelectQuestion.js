...
import {StyleSheet, TouchableNativeFeedback, View, FlatList} from 'react-native';
...
const Item = ({ title, onPress, selectedAnswers }) => {
    ...
    return <TouchableNativeFeedback onPress={onPress}>
        <View style={[isSelected ? styles.selectedItem:styles.nonSelectedItem]}>
            <Text style={[isSelected ? styles.selectedAnswerText : styles.nonSelectedAnswerText]}>{messages[title]}</Text>
        </View>
...
export default ({number, question, onAnswered = () => {}, selectedAnswers = []}) => {
